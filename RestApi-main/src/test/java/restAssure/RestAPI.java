...
public class RestAPI {
        ...
        public Object[][] getdata() throws IOException {
            String path = System.getProperty("user.dir") + "\\Resorces\\RestExcel.xls";
        ...
        Response resp = given().auth().basic("sk_test_51KTjXKSGuSpLy0ATL8CqeS3UhsCiz7XnhNNqJNFWsR2c22an7g86D4b8SMc8Ee6Omi2cP30Vg6pmSlu4NktiYYyH007lVzwx8a", "").formParam("email", email).
